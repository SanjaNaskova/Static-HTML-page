...
/* harmony import */ var _modules_main_script__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/main-script */ "./src/scripts/modules/main-script.js");
...
/***/ "./src/scripts/modules/main-script.js":
/*!********************************************!*\
  !*** ./src/scripts/modules/main-script.js ***!
  \********************************************/
/*! no static exports found */
...
var successfullLookup = function successfullLookup(position) {
  var _position$coords = position.coords,
      latitude = _position$coords.latitude,
      longitude = _position$coords.longitude;
  return fetch("https://api.opencagedata.com/geocode/v1/json?q=".concat(latitude, "+").concat(longitude, "&key=61e736aaffed49ea8d3d1a6c73937fac\n\n")).then(function (response) {
    return response.json();
  }).then(function (response) {
    // console.log(response.results[0].components["ISO_3166-1_alpha-3"]);
    var isoUser = response.results[0].components["ISO_3166-1_alpha-3"]; // console.log(isoUser);
    ...
    var showCurrency = document.querySelectorAll('.showCurrency');

    var changeCurrency = function changeCurrency(html) {
    ...
    if (countriesIso.euros.includes(isoUser)) {
      ...
      var _html = "\xA3";
      changeCurrency(_html);
    } else {
      var _html2 = "$";
      changeCurrency(_html2);
    }
  });
};
